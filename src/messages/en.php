...
return [
    ...
    'minLength'    => 'The string must be at least %s characters long',
    'maxLength'    => 'The string must be no more than %s characters long',
    'length'        => 'The string length must be between %s and %s characters',
    ...
    'maxValue'      => 'Value cannot exceed %s',
    'minValue'      => 'Value cannot be less than %s',
